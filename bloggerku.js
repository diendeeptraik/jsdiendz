 ...
 *
 * Dilarang COPY PASTE, BE CREATIVE
 * 
 */
! function (h, n) {
    function B(a, b) {
    ...
    function F() {
        ...
        if (n) {
            ...
            e.setAttribute("style", 'height: 52px; width: 54px; margin: 0px auto; overflow: hidden; position: relative; background: url("https://c.disquscdn.com/next/embed/assets/img/loader-bg.173909e4737a7481df14d5492b5eeb48.png") no-repeat; box-sizing: border-box;'), e.innerHTML = '<div style="box-sizing: border-box; width: 26px; height: 26px; position: absolute; top: 13px; left: 15px; border-width: 3px; border-style: solid; border-color: rgba(51, 54, 58, 0.4) transparent; border-radius: 13px; transform-origin: 50% 50% 0px; transition: transform 700s linear;"></div>';
            var a = e.firstChild;
            window.disqus_blogger_current_url = "http://www.bloggerku.com" + window.location.pathname, p = function () {
                var e, t;
                window.scrollY + window.innerHeight >= n.offsetTop && (a.style.transform = "rotate(360000deg)", (e = document.createElement("script")).type = "text/javascript", e.async = !0, e.src = "//" + disqus_shortname + ".disqus.com/blogger_item.js", (document.getElementsByTagName("head")[0] || document.getElementsByTagName("body")[0]).appendChild(e), (t = document.createElement("script")).type = "text/javascript", t.async = !0, t.src = "//" + disqus_shortname + ".disqus.com/blogger_index.js", (document.getElementsByTagName("head")[0] || document.getElementsByTagName("body")[0]).appendChild(t), window.removeEventListener("scroll", p), p = null)
    ...
    function D() {
        var e = document.querySelectorAll(".l-counter"),
            t = 0;
        B("https://graph.facebook.com/?id=" + window.location.href, function (e) {
    ...
    window.disqus_shortname = "bloggerku", window.disqus_blogger_current_url = "http://www.bloggerku.com" + window.location.pathname, window.disqus_blogger_homepage_url = "http://www.bloggerku.com/", window.disqus_blogger_canonical_homepage_url = "http://www.bloggerku.com/", window.console.log = window.console.info = void 0;
    var p = null,
        l, k, m, A, f, r, H, I, J, t;
    "diendzdessign.blogspot.com" != window.location.host && -1 == window.location.host.indexOf("demobloggerku.blogspot") && -1 == window.location.host.indexOf("1601534225076564813_a6d5510549403daf1f0f26b2e52c6f2977055029") && (window.location.href = "https://www.bloggerku.com/"), NodeList.prototype.forEach = function (t) {
        ...
        }, l.ga.l = 1 * new Date, m = k.createElement("script"), A = k.getElementsByTagName("script")[0], m.async = 1, m.src = "https://www.google-analytics.com/analytics.js", A.parentNode.insertBefore(m, A), ga("create", "UA-105587514-1", "auto"), ga("send", "pageview"), f = document.querySelector("#a .a"), r = f.querySelector("#c input"), H = f.getElementsByClassName("e-button")[0], I = f.getElementsByClassName("a-button")[0], J = f.offsetTop, window.addEventListener("scroll", function () {
        ...
        }), q(), z(), h.classList.contains("item") && (F(), D(), E()), document.getElementsByClassName("adsbygoogle").length && (k = document.createElement("script"), k.type = "text/javascript", k.async = !0, k.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js", m = document.getElementsByTagName("script")[0], m.parentNode.insertBefore(k, m)),
        function () {
            var e = document.createElement("script");
            e.type = "text/javascript", e.async = !0, e.src = "https://cdn.onesignal.com/sdks/OneSignalSDK.js", e.onload = function () {
